...
trait ProfunctorLaws[P[-_,+_]]
  ...
  def dimapComposition[A,A2,A3,B,B2,B3](pad: P[A,B], g: A3 => A2, f: A2 => A, i: B => B2, h: B2 => B3): Boolean = {
    //          dimap A2=>A B=>B2
    // P[A,B] ===================> F[A2,B2]
  ...
  def dimapCoherentWithMapAndContramap[A,A2,A3,B,B2,B3](pad: P[A,B], f: A2 => A, g: B => B2): Boolean = {
    //          dimap A2=>A B=>B2
    // P[A,B] ===================> F[A2,B2]
